...
public class Lidar : RacecarModule
{
    ...
    // LIDAR collision failure disabled for drone sim (no fragile-mount concern)
    ...
    private void Update()
    {
        // LIDAR visualization removed — sensor not present on drone
    }
    ...
    // Disabled for drone sim — LIDAR collision no longer triggers objective failure
