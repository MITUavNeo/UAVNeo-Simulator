...
///
/// On Tab/reset (via LevelManager.ResetDrone), call Repair() to fully restore.
///
/// Attach to the Drone GameObject (same object as Flight, Drone, etc.).
/// </summary>
public class CrashSystem : MonoBehaviour
{
    ...
    private void DetachArmGroup(int index, Vector3 impactPoint)
    {
        ...
        if (rBody != null) force += rBody.linearVelocity * 0.5f;
