...
public class ArMarkerToggle : MonoBehaviour
{
    ...
    /// </summary>
    private static readonly Color[] colors = new Color[] { Color.white, Color.red, new Color(0, 0.5f, 1), Color.green, Color.yellow, new Color(1, 0.5f, 0), new Color(0.8f, 0, 0.8f) };
