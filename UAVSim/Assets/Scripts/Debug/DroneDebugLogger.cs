...
/// Racecar, Flight, and PhysicsModule components).
///
...
public class DroneDebugLogger : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (this.racecar == null || this.flight == null || this.physicsModule == null)
        {
            Debug.LogError("[DroneDebugLogger] Missing required components (Racecar / Flight / PhysicsModule). Logger disabled.");
            this.enabled = false;
            return;
        }
    }
